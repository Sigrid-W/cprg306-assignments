export default function Item({name, quantity, category, onSelect})
{
    return(
    <li 
    className="list-none bg-gray-800 dark:bg-rose-200 px-3 py-3 mb-3 mr-3 border-0 rounded-2xl inline-grid text-center w-64 hover:bg-gray-700 dark:hover:bg-rose-300"
    onClick={onSelect}
    >
